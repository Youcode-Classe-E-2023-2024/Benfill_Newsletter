...
@section("content")
    <main class="h-screen">
        ...
        <form class="form" method="post" action="/request">
            @csrf
            <h3 class="text-black">Reset Request Here</h3>

            <label for="username">Email</label>
            <input class="login-input" name="email" type="text" placeholder="Email" id="loginEmail"
            ...
            <div class="social bg-gray-200 hover:bg-gray-300 flex justify-center">
                <button class="bg-gray" name="login" id="login-btn">Send Link</button>
            </div>
