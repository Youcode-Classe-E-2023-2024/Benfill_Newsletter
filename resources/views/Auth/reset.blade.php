...
@section("content")
    <main class="h-screen">
        ...
        <form class="form" method="post" action="/reset">
            ...
            <h3 class="text-black">Reset Password Here</h3>
            ...
            <input class="login-input" name="password" type="password" placeholder="Password" id="loginEmail"
                   required>
            @error("password")
            <p class="text-red-800 text-sm my-3">{{$message}}</p>
            @enderror
            <label for="password">Retype Password</label>
            <input class="login-input" name="confirmPassword" type="password" placeholder="Confirm Password" id="loginPassword"
                   required>
