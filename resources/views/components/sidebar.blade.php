        ...
        <li>
            <a id="membersButton"
               class="cursor-pointer flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                ...
                <span
                    class="ml-auto mr-6 text-sm bg-red-100 rounded-full px-3 py-px text-red-500">{{count($members)}}</span>
            </a>
        </li>
        @endrole
        <li>
            <a id="mediaButton"
               class="cursor-pointer flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                ...
                <span
                    class="ml-auto mr-6 text-sm bg-blue-100 rounded-full px-3 py-px text-blue-500">{{count($medias)}}</span>
            </a>
        </li>
