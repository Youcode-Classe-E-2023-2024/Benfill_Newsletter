<main id="mediaFormSection"
      class="container hidden mx-auto max-w-screen-lg h-full">
    <!-- file upload modal -->
    <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md"
        ...
        <form action="/media" method="post" enctype="multipart/form-data">
            ...
            <footer class="flex justify-end px-8 pb-8 pt-4">
                ...
                <div id="cancel"
                     class="cursor-pointer ml-3 rounded-sm px-3 py-1 hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                    Cancel
                </div>
            </footer>
        </form>
