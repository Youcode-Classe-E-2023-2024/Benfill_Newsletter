<section id="roleSection"
    class="hidden container px-4 mx-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> {{\App\Http\Controllers\UserController::getRole($user["id"])}}
                                </td>
