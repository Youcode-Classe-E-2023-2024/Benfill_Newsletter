                ...
                <td style="padding: 40px 0px 0px;">
                  ...
                  <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                    <div style="color: rgb(0, 0, 0); text-align: left;">
                      ...
                      <p style="padding-bottom: 16px">The Mailmeteor Newsletter is the best way to find out about the universe <em>...and
                          beyond</em>.</p>
                      ...
                      <p style="padding-bottom: 16px">Of course, you can <a href="http://127.0.0.1:8000/unsubscribe/{{$email["email"]}}" target="_blank" style="text-decoration: none;">unsubscribe anytime</a>.</p>
